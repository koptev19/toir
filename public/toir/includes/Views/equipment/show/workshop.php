...
<div class="row mb-3">
	...
	<div class="col-10 pl-3"><?php $this->view('equipment/show/params/user', ['name' => 'NACHALNIK_TSEKHA', 'node' => $node]); ?></div>
</div>
<div class="row mb-3">
	<div class='col-2'>Механик цеха:</div>
	<div class="col-10 pl-3"><?php $this->view('equipment/show/params/user', ['name' => 'MECHANIC_ID', 'node' => $node]); ?></div>
</div>
<div class="row mb-3">
...
<div class="row mb-3">
	...
	<div class="col-10 pl-3"><?php $this->view('equipment/show/params/int', ['name' => 'ID_PAPKI_DOKUMENTATSIYA', 'node' => $node]); ?></div>
</div>
<div class="row mb-3">
