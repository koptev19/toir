...
<h4 class='text-center pb-4'>Шаг 2</h4>

<div class=''>
<form method="post" action="master_report_date.php" id='form'>
...
<div class='mt-4 text-center'>
    <a href="#" onClick="submitForm(false)" class="btn btn-success mr-5">Перейти на шаг 3</a>
    <a href="#" onClick="$('#stepBack').val('1'); submitForm(true)" class='btn btn-outline-secondary ml-5'>Вернуться на предыдущий шаг</a>
</div>
</form>
...
<?php $workers = $this->service->workers; ?>
