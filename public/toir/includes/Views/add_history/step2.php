...
<div class='text-center pt-5'>
    <a class="btn btn-primary" href="<?php echo $this->getUrlStep1(); ?>" role="button">Создать еще</a>
    <a class="btn btn-outline-primary mx-4" href="#" role="button" onclick="closeAdd(); return false;">Завершить</a>
    <a class="btn btn-outline-secondary" href="<?php echo $this->getUrlStep1(); ?>&delete=<?php echo $operation->ID; ?>" role="button">Отменить</a>
</div>
